...
/data/user_password.txt ：(可外部更改)       管理员密码  {'mr': 'mrsoft', 'a': 's'} 账号: a 密码: s

/data/work_time.txt          :   (不可外部更改)  作息时间 

/data/employee_data.txt ： (不可外部更改)  员工名单(随机特征码)

/data/lock_record.txt        :    (不可外部更改)  打卡日报
